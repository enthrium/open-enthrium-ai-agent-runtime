---
name: sql-databases
description: Query a SQL database and summarize results in plain English. Use when user needs to explore a database, analyze data, or answer data questions from SQL.
license: MIT
compatibility: Requires PostgreSQL MCP connector (Claude/Codex) or postgresql connector in oe-config.json (OE)
allowed-tools: mcp__postgres__* mcp__postgresql__* postgresql mysql mssql
metadata:
  author: openenthrium
  version: "1.0"
---
